  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-sm">
          <blockquote className="text-xl font-medium text-white leading-relaxed mb-4">
            "ScanAR transformed how we present our product catalog — customers can see items in their space before buying."
          </blockquote>
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-lime-500 flex items-center justify-center text-sm font-bold text-white">JL</div>
            <div>
              <p className="text-sm font-semibold text-white">Jamie Lee</p>
              <p className="text-xs text-slate-400">Head of Design, Furnova</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 relative">
        ...
        <Link
          href="/"
          className="group absolute top-6 left-6 flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-900 transition-colors"
        >
        ...
        >
          ...
          <p className="text-slate-500 text-sm mb-7">Sign in to your ScanAR account</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link href="/signup" className="font-semibold text-lime-600 hover:text-lime-700 transition-colors">
              Sign up free
            </Link>
          </p>
        </motion.div>
